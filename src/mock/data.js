...
export const aboutData = {
  img: 'profilePic.jpg',
  paragraphOne: 'My strongest suit in web based development is the ability to handle wide range of latest web technologies. I strive to build detailed, user-friendly, and responsive user interfaces using JavaScript libraries (my current favorite is React ). For backend development I prefer some fresher backend technologies, such as Node.js, Express js, Mongodb.',
  // paragraphTwo: '',
  // paragraphThree: '',
...
export const projectsData = [
  ...
  },
  {
    ...
    info: 'A full stack Volunteer registration website using React js, MongoDb, Node js and Express js',
    info2: '',
